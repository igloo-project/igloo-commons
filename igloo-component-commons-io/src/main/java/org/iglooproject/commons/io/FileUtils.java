...
public final class FileUtils {
    ...
    public static Collection<File> listRecursively(
        ...
        if (directory == null) {
            throw new IllegalArgumentException(String.format(
                    "Null directory is not allowed (filter: %s, recurseFilter: %s)", resultsFilter, recurseFilter));
        }
    ...
    public static void cleanDirectory(File directory, Date onlyCleanFilesOlderThanThisDate) throws IOException {
        if (directory == null) {
            throw new IllegalArgumentException(String.format(
                    "Null directory is not allowed (olderThanDate: %s)", onlyCleanFilesOlderThanThisDate));
        }
        if (!directory.exists()) {
    ...
    private static void innerListRecursively(
            Collection<File> results, File directory, IOFileFilter resultsFilter, IOFileFilter recurseFilter) {
