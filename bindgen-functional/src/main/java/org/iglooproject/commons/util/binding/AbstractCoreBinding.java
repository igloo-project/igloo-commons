...
public class AbstractCoreBinding<R, P, T> extends AbstractBinding<R, P, T>
    implements ICoreBinding<R, T> {
  ...
  public AbstractCoreBinding(
      String name, BindingRoot<R, P> parentBinding, Getter<P, T> getter, Setter<P, T> setter) {
