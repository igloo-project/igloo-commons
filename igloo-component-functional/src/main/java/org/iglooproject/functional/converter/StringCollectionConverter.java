...
public class StringCollectionConverter<T, C extends Collection<T>> extends SerializableConverter2<String, C> {
    ...
    public StringCollectionConverter(Converter<String, T> converter, Supplier2<? extends C> supplier) {
