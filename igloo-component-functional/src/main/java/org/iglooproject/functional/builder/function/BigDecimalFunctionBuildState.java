...
public interface BigDecimalFunctionBuildState
		...
		>
		extends NumberFunctionBuildState<TBuildResult, BigDecimal, TBooleanState, TDateState, TLocalDateState, TLocalDateTimeState, TIntegerState, TLongState, TDoubleState, TBigDecimalState, TStringState> {
