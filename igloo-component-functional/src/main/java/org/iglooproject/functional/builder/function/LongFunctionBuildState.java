...
public interface LongFunctionBuildState
		...
		>
		extends NumberFunctionBuildState<TBuildResult, Long, TBooleanState, TDateState, TLocalDateState, TLocalDateTimeState, TIntegerState, TLongState, TDoubleState, TBigDecimalState, TStringState> {
