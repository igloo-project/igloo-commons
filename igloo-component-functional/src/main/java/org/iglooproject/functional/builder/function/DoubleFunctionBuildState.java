...
public interface DoubleFunctionBuildState
		...
		>
		extends NumberFunctionBuildState<TBuildResult, Double, TBooleanState, TDateState, TLocalDateState, TLocalDateTimeState, TIntegerState, TLongState, TDoubleState, TBigDecimalState, TStringState> {
