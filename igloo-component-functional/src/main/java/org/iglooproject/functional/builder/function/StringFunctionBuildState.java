...
public interface StringFunctionBuildState
		...
		>
		extends FunctionBuildState<TBuildResult, String, TBooleanState, TDateState, TLocalDateState, TLocalDateTimeState, TIntegerState, TLongState, TDoubleState, TBigDecimalState, TStringState> {
