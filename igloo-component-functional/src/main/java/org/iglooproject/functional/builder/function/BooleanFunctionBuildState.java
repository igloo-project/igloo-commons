...
public interface BooleanFunctionBuildState
		...
		>
		extends FunctionBuildState<TBuildResult, Boolean, TBooleanState, TDateState, TLocalDateState, TLocalDateTimeState, TIntegerState, TLongState, TDoubleState, TBigDecimalState, TStringState> {
