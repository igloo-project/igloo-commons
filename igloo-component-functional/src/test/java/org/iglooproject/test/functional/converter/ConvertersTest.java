...
class ConvertersTest {
    ...
    public static Stream<Arguments> data() throws URISyntaxException {
        return Stream.of(
                ...
                Arguments.arguments(
                        new StringCollectionConverter<>(StringBooleanConverter.get(), Suppliers2.<Boolean>arrayList()),
                        "true false true",
                        Lists.newArrayList(true, false, true)),
                Arguments.arguments(
                        new StringCollectionConverter<>(Converter.<String>identity(), Suppliers2.<String>arrayList())
                                .separator("_"),
                        "test1_test2_test3",
                ...
                Arguments.arguments(
                        new StringCollectionConverter<>(Converter.<String>identity(), Suppliers2.<String>arrayList())
                                ...
                                .reverse(),
                        Lists.newArrayList("test1", "test2", null),
                        "test1@test2"),
                Arguments.arguments(
                        StringDateConverter.get(),
                        "1990-04-18",
                        new GregorianCalendar(1990, Calendar.APRIL, 18, 0, 0, 0).getTime()),
                Arguments.arguments(
                        StringDateConverter.get(),
                        "2015-12-25",
                        new GregorianCalendar(2015, Calendar.DECEMBER, 25, 0, 0, 0).getTime()),
                Arguments.arguments(
                        StringDateConverter.get().reverse(),
                        new GregorianCalendar(1990, Calendar.APRIL, 18, 0, 0, 0).getTime(),
                        "1990-04-18"),
                Arguments.arguments(
                        StringDateConverter.get().reverse(),
                        ...
                        "2015-12-25"),
                Arguments.arguments(
                        StringDateTimeConverter.get(),
                        "1990-04-18 12:04",
                        new GregorianCalendar(1990, Calendar.APRIL, 18, 12, 4, 0).getTime()),
                Arguments.arguments(
                        StringDateTimeConverter.get(),
                        "2015-12-31 23:59:59",
                        new GregorianCalendar(2015, Calendar.DECEMBER, 31, 23, 59, 59).getTime()),
                Arguments.arguments(
                        StringDateTimeConverter.get().reverse(),
                        new GregorianCalendar(1990, Calendar.APRIL, 18, 12, 4, 0).getTime(),
                        "1990-04-18 12:04:00"),
                Arguments.arguments(
                        StringDateTimeConverter.get().reverse(),
    ...
    void testConvertersCollectionResult(
            Converter<Object, Object> converter, Object value, Collection<Object> expectedValue) {
