...
/**
 * An {@link UrlValidator} relying on {@link AnyTldDomainAndPortValidator} for domain and port
 * validation.
 */
public class AnyTldUrlValidator extends UrlValidator implements Serializable {
  ...
  /**
   * Copy from {@link UrlValidator} to avoid enforcing ascii-only characters, especially on the
   * domain name.
   */
  @Override
