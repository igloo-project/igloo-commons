...
/**
 * An {@link RegexValidator} for phone number validation: it's very permissive but should avoid most
 * of the errors.
 */
public class PermissivePhoneNumberValidator extends RegexValidator implements Serializable {
  ...
  private static final PermissivePhoneNumberValidator INSTANCE =
      new PermissivePhoneNumberValidator();
