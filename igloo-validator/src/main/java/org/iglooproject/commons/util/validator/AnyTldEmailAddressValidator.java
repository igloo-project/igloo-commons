...
public class AnyTldEmailAddressValidator extends EmailValidator implements Serializable {
  ...
  private static final AnyTldEmailAddressValidator INSTANCE =
      new AnyTldEmailAddressValidator(false);

  private static final AnyTldEmailAddressValidator INSTANCE_WITH_LOCAL =
      new AnyTldEmailAddressValidator(true);
