...
public class DateDiscreteDomainTest {
    ...
    public void dateWeekRange() {
        this.<LocalDateTime>range(
                DateDiscreteDomain.weeks(), LocalDateTime::parse, DATE, WEEK_PREVIOUS, WEEK_START, WEEK_END, WEEK_NEXT);
    }
    ...
    public void serialize() throws IOException, ClassNotFoundException {
        ...
        DateDiscreteDomain domain =
                (DateDiscreteDomain) new ObjectInputStream(new ByteArrayInputStream(baos.toByteArray())).readObject();
        this.<LocalDateTime>range(domain, LocalDateTime::parse, DATE, WEEK_PREVIOUS, WEEK_START, WEEK_END, WEEK_NEXT);
    }
}
