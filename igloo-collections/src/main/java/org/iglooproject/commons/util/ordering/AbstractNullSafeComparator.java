package org.iglooproject.commons.util.ordering;
...
public abstract class AbstractNullSafeComparator<T> extends Ordering<T>
  ...
  /**
   * Method called just before trying to compare the objects, in order to avoid potentially
   * expensive comparison operations.
   *
   * <p>If your comparator is <em>consistent with equals</em> (see {@link Comparator}), you may
   * safely override this and return <code>left.equals(right)</code>.
   */
