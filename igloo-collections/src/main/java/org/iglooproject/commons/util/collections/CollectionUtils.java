...
public final class CollectionUtils {
    ...
    public static <T> void replaceAll(
            Collection<T> dst, Collection<? extends T> src, Consumer<T> addConsumer, Consumer<T> removeConsumer) {
    ...
    public static <T> List<T> difference(
            Iterable<? extends T> source, Iterable<? extends T> filter, Equivalence<? super T> equivalence) {
