...
/**
 * Base implementation to support {@link PartitionDiscreteDomain} for various java.time
 * implementations.
 *
 * <p>Abstract methods allow to invoke *.truncateTo which is not part of any common interface (not
 * available in {@link Temporal}), and to manage {@link Temporal#with(TemporalField, long)} and
 * {@link Temporal#plus(long, TemporalUnit)} without any cast (Temporal version of this methods is
 * loosely typed).
 *
 ...
 * @see Instant
 */
abstract class AbstractTemporalDiscreteDomain<T extends Temporal & Comparable<? super T>>
    extends PartitionDiscreteDomain<T> implements Serializable {

  private static final long serialVersionUID = -4325301510023825071L;

  // this fields are transient; all instances of these objects are built as a readResolve-aware
  // object
  ...
  protected AbstractTemporalDiscreteDomain(
      ChronoUnit periodUnit, TemporalField startOfPeriodField, TemporalUnit normalizationUnit) {
