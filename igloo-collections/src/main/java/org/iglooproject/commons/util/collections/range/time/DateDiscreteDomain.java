 ...
 */
public class DateDiscreteDomain extends AbstractTemporalDiscreteDomain<LocalDateTime>
  ...
  private static final DateDiscreteDomain MONTHS =
      new DateDiscreteDomain(ChronoUnit.MONTHS, ChronoField.DAY_OF_MONTH, ChronoUnit.DAYS) {
        private static final long serialVersionUID = 1L;
