...
public final class Iterators2 {
   ...
   *
   * <p>Useful when you know that the user of this iterator will make structural changes to the
   * iterable before using the iterator, but you must give an iterator right now. This gives you
   * some kind of "joker".
   */
  public static <T> Iterator<T> deferred(Iterable<T> iterable) {
    return iterable instanceof List
        ? new DeferredListIterator<>((List<T>) iterable)
        : new DeferredIterator<>(iterable);
  }
