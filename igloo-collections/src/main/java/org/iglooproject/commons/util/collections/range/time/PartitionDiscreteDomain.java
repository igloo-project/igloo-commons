...
public abstract class PartitionDiscreteDomain<T extends Comparable> extends DiscreteDomain<T> {
   ...
   *
   * <p>If this value is already exactly on a point of this domain, this returns an object
   * representing the same value. Otherwise, this will return an object representing the closest
   * previous value in this domain.
   */
