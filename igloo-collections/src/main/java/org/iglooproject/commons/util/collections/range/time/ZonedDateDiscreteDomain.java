 ...
 */
public class ZonedDateDiscreteDomain extends AbstractTemporalDiscreteDomain<ZonedDateTime>
   ...
   *     <strong>must</strong> ensure that your range has been {@link
   *     ZonedDateDiscreteDomain#alignOut(Range) aligned} on this domain. Otherwise, you will
  ...
  private static final ZonedDateDiscreteDomain MONTHS =
      new ZonedDateDiscreteDomain(ChronoUnit.MONTHS, ChronoField.DAY_OF_MONTH, ChronoUnit.DAYS) {
        private static final long serialVersionUID = 1L;
  ...
  private static final ZonedDateDiscreteDomain WEEKS =
      new ZonedDateDiscreteDomain(
          ChronoUnit.WEEKS, WeekFields.of(DayOfWeek.MONDAY, 1).dayOfWeek(), ChronoUnit.DAYS) {
        private static final long serialVersionUID = 1L;
  ...
  /**
   * Keep constructor private, as instances of theses objects must implement readResolve for custom
   * deserialization.
   */
  private ZonedDateDiscreteDomain(
